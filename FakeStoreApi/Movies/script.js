...
function Movie()
{
   ...
   Movies.forEach(function (Movie)
  {
    ...
    like.style.paddingTop="0px";
    like.style.paddingBottom="0px";
    like.style.marginBottom="5px";
    like.style.marginTop="0px";
    like.addEventListener('click',Likes);
    like.style.cursor="pointer";

    let openbtn = document.createElement('button');
    openbtn.textContent="Open";
    openbtn.style.padding="3px";
    openbtn.style.borderRadius="5px";
    openbtn.style.cursor="pointer";
    openbtn.addEventListener('click',openModal);
    cd.append(image,title,p,like,openbtn);
